    ...
    return (
        <section className='book-edit'>
            ...
            <form onSubmit={onSaveBook}> 
                <label>Title: </label>
                    <input type='text' placeholder='Enter New Title' name='title' onChange={handleChange}/>
                <br></br>

                <label>Price(Amount): </label>
                    <input type='number' placeholder='Set Amount' name='listPrice.amount' onChange={handleChange}/>
